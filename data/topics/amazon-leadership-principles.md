...
sequenceDiagram
    ...
    participant HM as "Interviewer: Hiring Manager"
    ...
    alt "Story holds up under drilling"
        HM->>BR: "Independent write-up: strong signal"
    else "Story stays vague under drilling"
